...
#define ENABLE_CUSTOM_GCODE //permet d'activer ou de désactiver les fonctions M du robobend débutant à M5000
...
#define STRING_CONFIG_H_AUTHOR "(Robobend, V0.2)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "RoboBend"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 26.67, 88.89, 400, 84.88 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 500, 5, 20 }
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL_PIXELS 39       // Number of LEDs in the strip. (Longest strip when NEOPIXEL2_SEPARATE is disabled.)
